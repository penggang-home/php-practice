                ...
                <div class="paid-content">
                    <?php
                        try{
                            ...
                            $paidTotalNumSql = "select * from tb_info where type='求职信息' and checkstate = 1 ";
                            ...
                            // 获取当前页的内容
                            $paidSql = "select * from tb_info where type='求职信息' and checkstate = 1 order by id limit $paidStartNum,$paidPageSize ";
            ...
            <div class="free-content">
                <?php
                    try{
                        ...
                        $pageSql = "select * from tb_freeinfo where type='求职信息' and checkstate = 1 and sdate<showdate ";
                        ...
                        // 获取当前页的内容
                        $sql = "select * from tb_freeinfo where type='求职信息' and checkstate = 1 and sdate<showdate order by id limit $startPageNum,$pageSize ";
                        ...
                        while($res = $result->fetch(PDO::FETCH_ASSOC)){
                            ...
                            if($res['checkstate'] == 1 and $currentDate < $res['showdate'] and $res['type'] == "求职信息"){
                                ?>
                                    <div class='mb-2'>
                                        <div>
                                            <span class='content-type'>[<?php echo $res['type']; ?>]</span>
