                ...
                <div class="paid-content">
                    <?php
                        try{
                            ...
                            $paidTotalNumSql = "select * from tb_paidinfo where type='培训信息' and checkstate = 1 and sdate<showdate ";
                            ...
                            $paidSql = "select * from tb_paidinfo where type='培训信息' and checkstate = 1 and sdate<showdate order by id limit $paidStartNum,$paidPageSize ";
            ...
            <div class="free-content">
                <?php
                    try{
                        ...
                        $pageSql = "select * from tb_freeinfo where type='培训信息' and checkstate = 1";
                        ...
                        // 获取当前页的内容
                        $sql = "select * from tb_freeinfo where type='培训信息' and checkstate = 1  limit $startPageNum,$pageSize ";
