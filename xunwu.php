                ...
                <div class="paid-content">
                    <?php
                        try{
                            ...
                            $paidTotalNumSql = "select * from tb_paidinfo where type='寻物启事' and checkstate = 1 and sdate<showdate ";
                            ...
                            $paidSql = "select * from tb_paidinfo where type='寻物启事' and checkstate = 1 and sdate<showdate order by id limit $paidStartNum,$paidPageSize ";
                            ...
                            while($res = $paidResult->fetch(PDO::FETCH_ASSOC)){
                                if($res['checkstate'] == 1 and $res['type'] == "寻物启事"){
                                    ?>
                                    <div class='mb-2'>
                                        <div>
                ...
                <nav class='page' aria-label="...">
                    <ul class="pagination mb-1">
                        <li class="page-item <?php if($paidCurrentPage == 1){echo 'disabled';}?>">
                            <a class="page-link" href="xunwu.php?paidpage=1&<?php echo 'freepage='.$currentPageNum?>">首页</a>
                        </li>
                        <li class="page-item <?php if($paidCurrentPage == 1){echo 'disabled';}?>">
                            <a class="page-link" href="xunwu.php?paidpage=<?php echo $paidCurrentPage-1 ?>&<?php echo 'freepage='.$currentPageNum?>">上一页</a>
                        </li>
                        <?php
                            for($i=1;$i<=$paidTotalPage;$i++){
                                ?>  
                                    <li class="page-item <?php if($i == $paidCurrentPage){echo 'active';}?>">
                                        <a class="page-link" href="xunwu.php?paidpage=<?php echo $i ?>&<?php echo 'freepage='.$currentPageNum?>"> 
                                            <?php echo $i ?>
                                        </a>
                                    </li>
                        ...
                        <li class="page-item <?php if($paidCurrentPage == $paidTotalPage){echo 'disabled';}?>">
                            <a class="page-link" href="xunwu.php?paidpage=<?php echo $paidCurrentPage+1 ?>&<?php echo 'freepage='.$currentPageNum?>">下一页</a>
                        </li>
                        <li class="page-item <?php if($paidCurrentPage == $paidTotalPage){echo 'disabled';}?>">
                            <a class="page-link" href="xunwu.php?paidpage=<?php echo $paidTotalPage ?>&<?php echo 'freepage='.$currentPageNum?>">尾页</a>
                        </li>
                    </ul>
                </nav>
                <div>
            ...
            <div class="free-content">
                <?php
                    try{
                        ...
                        $pageSql = "select * from tb_freeinfo where type='寻物启事' and checkstate = 1";
                        ...
                        // 获取当前页的内容
                        $sql = "select * from tb_freeinfo where type='寻物启事' and checkstate = 1  limit $startPageNum,$pageSize ";
            ...
            <nav class='page' aria-label="...">
                <ul class="pagination mb-1">
                    <li class="page-item <?php if($currentPageNum == 1){echo 'disabled';}?>">
                        <a class="page-link" href="xunwu.php?freepage=1&<?php echo 'paidpage='.$paidCurrentPage?>">首页</a>
                    </li>
                    <li class="page-item <?php if($currentPageNum == 1){echo 'disabled';}?>">
                        <a class="page-link" href="xunwu.php?freepage=<?php echo $currentPageNum-1 ?>&<?php echo 'paidpage='.$paidCurrentPage?>">上一页</a>
                    </li>
                    <?php
                        for($i=1;$i<=$pageCountNum;$i++){
                            ?>  
                                <li class="page-item <?php if($i == $currentPageNum){echo 'active';}?>">
                                    <a class="page-link" href="xunwu.php?freepage=<?php echo $i ?>&<?php echo 'paidpage='.$paidCurrentPage?>"> 
                                        <?php echo $i?>
                                    </a>
                                </li>
                            <?php
                    ...
                    <li class="page-item <?php if($currentPageNum == $pageCountNum){echo 'disabled';}?>">
                        <a class="page-link" href="xunwu.php?freepage=<?php echo $currentPageNum+1 ?>&<?php echo 'paidpage='.$paidCurrentPage?>">下一页</a>
                    </li>
                    <li class="page-item <?php if($currentPageNum == $pageCountNum){echo 'disabled';}?>">
                        <a class="page-link" href="xunwu.php?freepage=<?php echo $pageCountNum ?>&<?php echo 'paidpage='.$paidCurrentPage?>">尾页</a>
                    </li>
                </ul>
            </nav>
        </article>
