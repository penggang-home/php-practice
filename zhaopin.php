            ...
            <nav class='page' aria-label="...">
                <ul class="pagination">
                    <li class="page-item <?php if($currentPageNum == 1){echo 'disabled';}?>">
                        <a class="page-link" href="zhaopin.php?freepage=1&<?php echo 'paidpage='.$paidCurrentPage?>">首页</a>
                    </li>
                    <li class="page-item <?php if($currentPageNum == 1){echo 'disabled';}?>">
                        <a class="page-link" href="zhaopin.php?freepage=<?php echo $currentPageNum-1 ?>&<?php echo 'paidpage='.$paidCurrentPage?>">上一页</a>
                    </li>
                    <?php
                        for($i=1;$i<=$pageCountNum;$i++){
                            ?>  
                                <li class="page-item <?php if($i == $currentPageNum){echo 'active';}?>">
                                    <a class="page-link" href="zhaopin.php?freepage=<?php echo $i ?>&<?php echo 'paidpage='.$paidCurrentPage?>"> 
                                        <?php echo $i?>
                                    </a>
                                </li>
                            <?php
                    ...
                    <li class="page-item <?php if($currentPageNum == $pageCountNum){echo 'disabled';}?>">
                        <a class="page-link" href="zhaopin.php?freepage=<?php echo $currentPageNum+1 ?>&<?php echo 'paidpage='.$paidCurrentPage?>">下一页</a>
                    </li>
                    <li class="page-item <?php if($currentPageNum == $pageCountNum){echo 'disabled';}?>">
                        <a class="page-link" href="zhaopin.php?freepage=<?php echo $pageCountNum ?>&<?php echo 'paidpage='.$paidCurrentPage?>">尾页</a>
                    </li>
                </ul>
            </nav>
        </article>
